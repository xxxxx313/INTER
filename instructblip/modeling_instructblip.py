...
class InstructBlipForConditionalGeneration(InstructBlipPreTrainedModel):
    ...
    def generate(
        ...
        **generate_kwargs,
        ...
        #maskimage_ shapley
        inputs_embeds_mask_image_shapley = self.get_input(image_rand, qformer_attention_mask, qformer_input_ids, input_ids, attention_mask)
        #masktext
        inputs_embeds_mask_text = self.get_input(**just_q)
        #maskall
        inputs_embeds_mask_all = self.get_input(image_rand, just_q['qformer_attention_mask'], just_q['qformer_input_ids'], just_q['input_ids'],just_q['attention_mask'] )
