...
import transformers
from transformers.generation.utils import SampleOutput,GenerateOutput
...
def generate(
    ...
    **kwargs,
    ...
    #print("inputs in transformer", inputs) none
    #print("model_kwargs", model_kwargs) {inputembed,attentonmask}
    #inputs_embeds_mask_all = None
    #print("success")
    inputs_tensor, model_input_name, model_kwargs = self._prepare_model_inputs(
        inputs, generation_config.bos_token_id, model_kwargs
    )
    #
    #print("model_kwargs", model_kwargs) not change
    #print("input_tensor", inputs_tensor) inputembed
    print("nomask")
    inputs_tensor = inputs_tensor['nomask']
